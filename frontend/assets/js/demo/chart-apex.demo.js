...
var handleAreaChart = function() {
	...
	var options = {
		...
		colors: ["#2fab8e", COLOR_PINK],
		series: [{
			name: 'Licenças  Emitidas',
			data: [31, 0, 5, 100, 42, 109, 120]
		}, {
			name: 'Carteiras Emitidas',
			data: [11, 99, 70, 5, 50, 0, 70]
		}],

		xaxis: {
			type: 'datetime',
			categories: ['2020-01-19T10:40:00', '2020-02-19T11:30:00', '2020-03-19T12:30:00', '2020-04-19T13:30:00', '2020-05-19T14:30:00', '2020-06-19T15:30:00', '2020-07-19T16:30:00'],
			axisBorder: {
				show: true,
				color: COLOR_SILVER_TRANSPARENT_5,
				height: 1,
